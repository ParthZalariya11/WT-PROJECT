...
export default function Add() {
  ...
  const handleSubmit = async (e) => {
    ...
    studentData.append("studentId", student.studentId);
    studentData.append("firstName", student.firstName);
    studentData.append("lastName", student.lastName);
    studentData.append("course", student.course);
    studentData.append("address", student.address);
    studentData.append("rfidBadgeNumber", student.rfidBadgeNumber);
    if (file) {
    ...
    try {
      ...
      showMessage(true, "error", errorMessage);
    }
  };
